...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL, KC_LALT, MO(_NAV), XXXXXXX, XXXXXXX,         KC_SPC ,        XXXXXXX, XXXXXXX, XXXXXXX,  MO(_NAV),  KC_RALT, XXXXXXX, KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,            KC_PDOT, KC_PENT,    KC_FIND, KC_CUT
    ),
    [_NAV] = LAYOUT_all(
    ...
    ______,  ______,  ______,  ______,  ______, ______, KC_DEL,  KC_END,   XXXXXXX, KC_PGDN,  ______, ______,         ______, ______,            ______,           ______,______,______,______,    ______,______,
    ______,  ______,  ______,  ______,  ______,         ______,            ______, ______,  ______, ______, ______, ______, ______,     ______,______,______,    ______,       ______,______,    ______,______
    ),
    [2] = LAYOUT_all(
                      ______,  ______,  ______, ______, ______,  ______,  ______, ______,  ______, ______, ______, ______,
