...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL, KC_LALT, KC_BSPC, XXXXXXX, XXXXXXX,         KC_SPC ,        XXXXXXX, XXXXXXX, XXXXXXX, KC_ENT,  KC_RALT, XXXXXXX, KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,            KC_PDOT, KC_PENT,    KC_FIND, KC_CUT
    ),
    [1] = LAYOUT_all(
